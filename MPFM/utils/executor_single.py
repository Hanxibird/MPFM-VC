...
from MPFM.utils.train_utils_single import update_parameter_and_lr, log_per_step, log_per_save, batch_forward, batch_backward, save_model, MPFM_join
...
class Executor:
    ...
    def train_one_epoc(self, model, optimizer, scheduler, train_data_loader, cv_data_loader, writer, info_dict, group_join):
        ...
        for batch_idx, batch_dict in enumerate(train_data_loader):
            ...
            if group_join!=0:
                if MPFM_join(group_join, info_dict):
                    break
            ...
            # NOTE specify save_per_step in MPFM.yaml if you want to enable step save
    ...
    def cv(self, model, cv_data_loader, writer, info_dict, on_batch_end=True):
        ...
        for batch_idx, batch_dict in enumerate(cv_data_loader):
            ...
            num_utts = len(batch_dict["speech_token"])
