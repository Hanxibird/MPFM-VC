...
try:
    ...
    use_ttsfrd = False
from MPFM.utils.frontend_utils import contains_chinese, replace_blank, replace_corner_mark, remove_bracket, spell_out_number, split_paragraph
...
class MPFMFrontEnd:
    ...
    def __init__(self,
        ...
        if self.use_ttsfrd:
            ...
            assert self.frd.initialize('{}/../../pretrained_models/MPFM-ttsfrd/resource'.format(ROOT_DIR)) is True, 'failed to initialize ttsfrd resource'
